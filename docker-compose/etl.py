...
# Combine the preceding 3 processes into one, and combine their results with the users dimensional data
...
# Upload the data can be potentially time consuming so use async 
